...
const Contact = () => {
 ...
 return (
  <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-center bg-no-repeat bg-[length:90%_auto] ' >
   ...
   <p className='text-center max-w-2xl mx-auto mt-5 text-gray-600 mb-12 font-Ovo' >
   ...
   <form onSubmit={onSubmit} className='max-w-2xl mx-auto' >
    ...
    <textarea name='message' className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6' rows={6} placeholder='Enter your message' required></textarea>
    <button type='submit' className='font-Ovo flex items-center justify-center gap-2 text-sm mt-5 w-max text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-8 mx-auto my-20 hover:bg-black hover:text-white duration-500' >
     Send message <Image src={assets.right_arrow_white} alt='' className='w-4' />
    </button>
    <p className='text-center text-gray-600 font-Ovo mt-4' >
     {result
      ? result
      : "I'd love to hear from you! Whether you have a question about my services, want to collaborate on a project, or just want to say hello, feel free to reach out. I'm always happy to connect with new people and discuss exciting opportunities."}
    </p>
