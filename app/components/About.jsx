   ...
   <motion.div
    ...
    <motion.div
     ...
     <p className='mb-10 max-w-2xl font-Ovo text-gray-600 dark:text-white/80' >
      I am an experienced Fullstuck Developer with two years of experience in the field. Throughout my career, I have had the privilege of collaborationg with prestigious organizations, contributing to their success and growth.
     </p>
